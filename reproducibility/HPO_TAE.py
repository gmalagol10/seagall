...
print(time.strftime("%a, %d %b %Y %H:%M:%S", time.localtime()), f"HPO TAE started", flush=True)
...
study = hpo.run_HPO_TAE(M=adata.X, y=adata.obs.target.to_numpy(), model_name=model_name)
